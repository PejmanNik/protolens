// TODO: reimplement this: https://github.com/protobufjs/protobuf.js/wiki/How-to-reverse-engineer-a-buffer-by-hand
// From: https://github.com/konsumer/rawproto
// License: MIT
// author: konsumer
...
const prefixify = (prefix, path) => path.split('.').map((v) => `${prefix}${v}`).join('.')
